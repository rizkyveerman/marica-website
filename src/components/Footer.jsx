...
const Footer = () => {
  return (
    <footer className="px-4 py-4 pb-28 md:pb-0 md:px-16 md:py-8 bg-white w-full grid gap-4">
      <div className="w-full flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="">
          <p className="mb-4 text-sm">Download aplikasi Marica</p>
          <ul className="flex items-center gap-4">
            <li className="p-1 bg-semangka rounded-lg grid place-content-center">
              <Link
      ...
      <div className="h-[1px] w-full bg-arang my-2"></div>
      <div className="flex flex-col justify-start items-center md:flex-row md:justify-between md:items-start gap-4">
