  ...
  return (
    <div className="flex items-center justify-between mb-2 md:mb-4 px-4">
      <div className="flex flex-col items-center">
        <p className="font-semibold text-lg text-pink-600">a</p>
      ...
      <div className="flex flex-col items-center">
        <p className="font-semibold text-lg text-pink-600">123</p>
        <p className="text-slate-500 text-xs">Number</p>
      </div>
      <div className="flex flex-col items-center">
        <p className="font-semibold text-lg text-pink-600">9%</p>
